...
namespace Telegram.Bot.Examples.Echo
{
    public class TelegramHandlers
    {
        ...
        public TelegramHandlers(NoteRepository noteRepository)
        {
        ...
        public async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
        {
            var handler = update.Type switch
            {
                ...
                _ => SomeFuckingErrorWithSwitch(botClient, update.Message)
            };
        ...
        private async Task SomeFuckingErrorWithSwitch(ITelegramBotClient botClient, Message message)
        {
            throw new NotImplementedException("произошёл казус");
        }
